        ...
        if(v==contactsBtn){
            ...
            if(ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                ...
                try{
                    ...
                    Uri phoneURI= FileProvider.getUriForFile(Main2Activity.this, BuildConfig.APPLICATION_ID+
                            ".provider", filePath);
                    Intent intent=new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
            ...
            Uri phtoURL=FileProvider.getUriForFile(Main2Activity.this, BuildConfig.APPLICATION_ID+
                    ".provider", filePath);
